...
const BottomButtons = () => {
    return (
        <div className="bottom-grid-controller">
            ...
            <button className="control-button delete-first__col" type="submit" value="add column"> &#8594;</button>
            ...
            <button className="control-button insert-last__col" type="submit" value="add column"> &#8594;</button>
        </div>
    );
}
